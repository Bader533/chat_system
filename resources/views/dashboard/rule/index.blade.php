...
@section('title',__('site.rule'))

@section('page_name',__('site.rule'))
...
<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
    ...
    <!--end::Item-->
    <!--begin::Item-->
    <li class="breadcrumb-item text-muted">{{__('site.rule')}}</li>
    <!--end::Item-->
</ul>
@endsection
...
<script>
    ...
    function getRule(page = 1, query = null){
        axios.get('/getrule', {
            params: {
                page: page,
                query: query,
