...
@section('page_name',__('site.gla_event'))
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                        <!--begin::Add customer-->
                        <a href="{{ route('gla-event.create') }}" class="btn btn-primary">{{__('site.add_new_event')}}
                        </a>
                        <!--end::Add customer-->
                    </div>
                    <!--end::Toolbar-->
...
<script>
    ...
    function getEvents(page=1 , query=null){
        axios.get('/getEvent',{
            params: {
                page: page,
                query: query,
