...
@section('title',__('site.permission'))

@section('page_name',__('site.permission'))
...
<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
    ...
    <!--end::Item-->
    <!--begin::Item-->
    <li class="breadcrumb-item text-muted">{{__('site.permission')}}</li>
    <!--end::Item-->
</ul>
@endsection
...
<script>
    ...
    function getPermission(page = 1, query = null){
