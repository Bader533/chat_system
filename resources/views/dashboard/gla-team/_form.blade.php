            ...
            <div class="card-body pt-0">
                ...
                <div class="row">
                    <div class="col-6 mb-10 fv-row">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" name="title_en" id="title_en" value="{{$team->title_en ?? null}}"
                    ...
                    <div class="col-6 mb-10 fv-row">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" name="title_ar" id="title_ar" value="{{$team->title_ar ?? null}}"
