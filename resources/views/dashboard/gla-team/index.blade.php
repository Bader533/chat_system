...
@section('page_name',__('site.gla_team'))
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                        <!--begin::Add customer-->
                        <a href="{{ route('gla-team.create') }}" class="btn btn-primary">{{__('site.add_new_team')}}
                        </a>
                        <!--end::Add customer-->
                    </div>
                    <!--end::Toolbar-->
...
<script>
    ...
    function buttonSideBar() {
        const button = document.getElementById('gla_team');
    ...
    function getTeams(page=1 , query=null){
        axios.get('/getTeam',{
            params: {
                page: page,
                query: query,
