...
@section('title',__('site.levels'))

@section('page_name',__('site.levels'))
...
<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
    ...
    <!--end::Item-->
    <!--begin::Item-->
    <li class="breadcrumb-item text-muted">{{__('site.levels')}}</li>
    <!--end::Item-->
</ul>
@endsection
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                        <!--begin::Add customer-->
                        <a href="{{ route('level.create') }}" class="btn btn-primary">{{__('site.add_new_level')}}
                        </a>
                        <!--end::Add customer-->
                    </div>
                    <!--end::Toolbar-->
...
<script>
    ...
    function getLevels(page=1 , query=null){
        axios.get('/get-levels',{
            params: {
                page: page,
                query: query,
            }
