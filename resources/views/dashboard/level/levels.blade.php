    ...
    <tbody class="fw-semibold text-gray-600" id="table_data">
        ...
        <tr>
            ...
            <td class="text-end">
                ...
                <a href="{{route('level.edit',$item->slug)}}"
        ...
        <div class="col-sm">
            <div class="pagination">
                ...
                <li class="page-item"><a class="page-link"
                        onclick="getLevels('{{ $contacts->currentPage() - 1 }}')">‹</a>
                </li>
                @endif
                @php
                ...
                @if ($startPage > 1)
                <li class="page-item"><a class="page-link" onclick="getLevels(1)">1</a></li>
                @if ($startPage > 2)
                <li class="page-item disabled"><span class="page-link">...</span></li>
                @endif
                @endif
                ...
                @for ($i = $startPage; $i <= $endPage; $i++) <li
                    ...
                    <a class="page-link" onclick="getLevels('{{ $i }}')">{{ $i }}</a>
                    </li>
                    @endfor
                    ...
                    @if ($endPage < $contacts->lastPage())
                        @if ($endPage < $contacts->lastPage() - 1)
                            ...
                            @endif
                            <li class="page-item"><a class="page-link"
                                    onclick="getLevels('{{ $contacts->lastPage() }}')">{{
                            ...
                            <li class="page-item"><a class="page-link"
                                    onclick="getLevels('{{ $contacts->currentPage() + 1 }}')">›</a></li>
                            @else
                            <li class="page-item disabled"><span class="page-link">›</span></li>
                            @endif
            </div>
