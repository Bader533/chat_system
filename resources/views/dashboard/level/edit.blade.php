...
@section('title',__('site.level'))

@section('page_name',__('site.edit').' '.$level->name_ar)
...
<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
    ...
    <!--end::Item-->
    <!--begin::Item-->
    <li class="breadcrumb-item text-muted">{{__('site.level')}}</li>
    <!--end::Item-->
    <!--begin::Item-->
    <li class="breadcrumb-item">
        <span class="bullet bg-gray-400 w-5px h-2px"></span>
...
<div id="kt_app_content" class="app-content flex-column-fluid">
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            {{-- form --}}
            @include('dashboard.level._form', ['level' => $level,'function' => 'update'])
            {{-- end form --}}
        </div>
...
<script>
    ...
    function update() {
        ...
        axios.post('/level/{{$level->slug}}', formData)
