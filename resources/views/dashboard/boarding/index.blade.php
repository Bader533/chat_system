                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                    ...
                    <thead>
                        ...
                        <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">{{__('site.place')}}</th>
                    ...
                    <tbody class="fw-semibold text-gray-600" id="table_data">
                        ...
                        <tr>
                            ...
                            <!--begin::Date=-->
                            <td>{{ date('m/d/Y', strtotime($boarding->created_at)) }}</td>
                            <!--end::Date=-->
                            <!--begin::Action=-->
                            ...
                            <td class="text-end">
                                ...
                                <a href="{{ route('boarding.edit', $boarding->id) }}"
                                ...
                                <!--begin::Delete-->
                                <a onclick="confirmDelete('{{$boarding->id}}',this)"
                    ...
                    <div class="row">
                        <div class="col-sm">
                            <div style="float: right">
                                {{ $boardings->links('pagination::bootstrap-4') }}
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    $('#search_data').on('keyup', function() {
        ...
        if ($value) {
            ...
            $.ajax({
                type: 'get',
                url: "{{ route('search.boarding') }}",
                data: {
                    'search': $value
                },
                success: function(data) {
                    $('#table_search_data').html(data);
                },
            });
        } else {
            $('#table_data').show();
            $('#table_search_data').hide();
        }
