            ...
            <form id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row">
                ...
                <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <select class="form-select mb-2" data-control="select2" data-hide-search="true"
                                ...
                                <option></option>
                                <option value="1" @if($boarding->status == 1) selected="selected"
                                    @endif>{{__('site.active')}}</option>
                                <option value="0" @if($boarding->status == 0) selected="selected"
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            <!--begin::Select2-->
                            <input type="number" id="place" value="{{$boarding->place}}" placeholder="1"
                                class="form-control">
                            {{-- <select class="form-select mb-2" data-control="select2" data-hide-search="true"
                                    ...
                                    <div class="card-body text-center pt-0">
                                        ...
                                        <style>
                                            .image-input-placeholder {
                                                background-image: url('{{$boarding->avatar_url}}');
                                            }
                                        </style>
                            ...
                            <div class="row">
                                <div class="col-6 mb-10 fv-row">
                                    ...
                                    <input type="text" name="title_en" id="title_en" class="form-control mb-2"
                                        placeholder="{{__('site.title_en')}}" value="{{$boarding->title_en}}" required />
                                    <!--end::Input-->
                                </div>
                                <div class="col-6 mb-10 fv-row">
                                    <!--begin::Label-->
                                    ...
                                    <input type="text" name="title_ar" id="title_ar" class="form-control mb-2"
                                        placeholder="{{__('site.title_ar')}}" value="{{$boarding->title_ar}}" required />
                                    <!--end::Input-->
                                </div>
                            </div>
                            <!--end::title-->
                            ...
                            <div class="row">
                                <div class="col-6 mb-10 fv-row">
                                    ...
                                    <input type="text" class="form-control mb-2" name="description_en" id="description_en"
                                        placeholder="{{__('site.description_en')}}" value="{{$boarding->description_en}}" required>
                                    <!--end::Input-->
                                </div>
                                <div class="col-6 mb-10 fv-row">
                                    <!--begin::Label-->
                                    ...
                                    <input type="text" class="form-control mb-2" name="description_ar" id="description_ar"
                                        placeholder="{{__('site.description_ar')}}" value="{{$boarding->description_ar}}" required>
                                    <!--end::Input-->
                                </div>
                            </div>
                            <!--end::description-->
...
<script>
    ...
    function update() {
        ...
        axios.post('/boarding/{{$boarding->id}}',formData)
