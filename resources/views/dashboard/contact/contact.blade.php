<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
    ...
    <tbody class="fw-semibold text-gray-600" id="table_data">
        ...
        <tr>
            <!--begin::Name=-->
            <td>
                <a class="text-gray-800 text-hover-primary mb-1">{{ $contact->f_name }} {{ $contact->l_name }} </a>
            </td>
            <!--end::Name=-->
            ...
            <td class="text-end">
                ...
                <a href="{{route('contact.show',$contact->slug)}}"
                ...
                <!--begin::Delete-->
                <a onclick="confirmDelete('{{$contact->id}}',this)"
