...
@section('title',__('site.tasks'))

@section('page_name',__('site.tasks'))
...
<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
    ...
    <!--end::Item-->
    <!--begin::Item-->
    <li class="breadcrumb-item text-muted">{{__('site.tasks')}}</li>
    <!--end::Item-->
</ul>
@endsection
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                        <!--begin::Add customer-->
                        <a href="{{ route('task.create') }}" class="btn btn-primary">{{__('site.add_new_task')}}
                        </a>
                        <!--end::Add customer-->
                    </div>
                    <!--end::Toolbar-->
...
<script>
    ...
    function getTasks(page=1 , query=null){
        axios.get('/get-tasks',{
            params: {
                page: page,
                query: query,
