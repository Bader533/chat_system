<form id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row">
            ...
            <div class="card-body text-center pt-0">
                ...
                <style>
                    .image-input-placeholder {
                        background-image: url('{{asset($task->avatar_url ?? "assets/media/svg/files/blank-image.svg")}}');
                    }
                </style>
    ...
    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
            ...
            <div class="card-body pt-0">
                ...
                <div class="row">
                    <div class="col-6 mb-10 fv-row">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" name="name_en" id="name_en" value="{{$task->name_en ?? null}}"
                    ...
                    <div class="col-6 mb-10 fv-row">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" name="name_ar" id="name_ar" value="{{$task->name_ar ?? null}}"
                ...
                <div class="row">
                    <div class="col-6 mb-10 fv-row">
                        ...
                        <input type="text" name="description_en" id="description_en"
                            value="{{$task->description_en ?? null}}" class="form-control mb-2"
                    ...
                    <div class="col-6 mb-10 fv-row">
                        ...
                        <input type="text" name="description_ar" id="description_ar"
                            value="{{$task->description_ar ?? null}}" class="form-control mb-2"
                ...
                <div class="row">
                    <div class="col mb-10 fv-row">
                        <!--begin::Label-->
                        <label class="required form-label">{{__('site.days')}}</label>
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" name="days" id="days" value="{{$task->days ?? null}}"
                            class="form-control mb-2" placeholder="{{__('site.days')}}" required />
                        <!--end::Input-->
                    </div>
                </div>
                <!--end::days-->
                ...
                <div class="mb-10 fv-row">
                    ...
                    <select class="form-select mb-2" data-control="select2" data-hide-search="true"
                        ...
                        <option></option>
                        <option value="1" @selected(($task->status ?? null) == 1)>{{__('site.active')}}</option>
                        <option value="0" @selected(($task->status ?? null) == 0)>{{__('site.non_active')}}</option>
                    </select>
                </div>
                <!--end::status-->
                ...
                <div class="row">
                    <div class="col-6 mb-10 fv-row">
                        ...
                        <select class="form-select mb-2" data-control="select2" data-hide-search="true"
                            ...
                            <option></option>
                            <option value="1" @selected(($task->point_status ?? null) == 1)>{{__('site.active')}}
                            </option>
                            <option value="0" @selected(($task->point_status ?? null) == 0)>{{__('site.non_active')}}
                            </option>
                        </select>
                        <!--end::Input-->
                    </div>
                    <div class="col-6 mb-10 fv-row">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" name="point" id="point" value="{{$task->point ?? null}}"
                            class="form-control mb-2" placeholder="{{__('site.point')}}" required />
                        <!--end::Input-->
                    </div>
                </div>
                <!--end::point-->
                ...
                <div class="row">
                    <div class="col-6 mb-10 fv-row">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" name="diamonds" id="diamonds" value="{{$task->diamonds ?? null}}"
                            class="form-control mb-2" placeholder="{{__('site.diamonds')}}" required />
                        <!--end::Input-->
                    </div>
                    <div class="col-6 mb-10 fv-row">
                        <!--begin::Label-->
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" name="gold" id="gold" value="{{$task->gold ?? null}}"
                            class="form-control mb-2" placeholder="{{__('site.gold')}}" required />
                        <!--end::Input-->
                    </div>
                    <div class="col-6 mb-10 fv-row">
                        <!--begin::Label-->
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" name="silver" id="silver" value="{{$task->silver ?? null}}"
                            class="form-control mb-2" placeholder="{{__('site.silver')}}" required />
                        <!--end::Input-->
                    </div>
                </div>
        ...
        <div class="d-flex justify-content-end">
            <!--begin::Button-->
            <a href="{{route('task.index')}}" id="kt_ecommerce_add_product_cancel"
