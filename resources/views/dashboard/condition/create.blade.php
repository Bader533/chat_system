            ...
            <form id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row">
                ...
                <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                            ...
                            <div class="row">
                                <div class="col-6 mb-10 fv-row">
                                    ...
                                    <input type="text" name="title_en" id="title_en" class="form-control mb-2"
                                        placeholder="{{__('site.title_en')}}" @if($condition) value="{{$condition->title_en}}"
                                        @endif required />
                                    <!--end::Input-->
                                </div>
                                <div class="col-6 mb-10 fv-row">
                                    ...
                                    <input type="text" name="title_ar" id="title_ar" class="form-control mb-2"
                                        placeholder="{{__('site.title_ar')}}" @if($condition) value="{{$condition->title_ar}}"
                                        @endif required />
                                    <!--end::Input-->
                                </div>
                            </div>
                    ...
                    <div class="d-flex justify-content-end">
                        <!--begin::Button-->
                        <a href="{{route('condition.index')}}" id="kt_ecommerce_add_product_cancel"
