...
<div id="kt_app_content" class="app-content flex-column-fluid">
    ...
    <div id="kt_app_content_container" class="app-container container-xxl">
                            ...
                            <div class="d-flex flex-column flex-grow-1 pe-8">
                                ...
                                <div class="d-flex flex-wrap">
                                    ...
                                    <div
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="fs-2 fw-bold" data-kt-countup="true"
                                                data-kt-countup-value="{{$user->total_diamonds}}">
                                                0</div>
                                        </div>
                                        <!--end::Number-->
                                        <!--begin::Label-->
                                        <div class="fw-semibold fs-6 text-gray-400">Diamonds</div>
                                        <!--end::Label-->
                                    </div>
                                    <!--end::Stat-->
                                    <!--begin::Stat-->
                                    <div
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="fs-2 fw-bold" data-kt-countup="true"
                                                data-kt-countup-value="{{$user->total_gold}}" data-kt-countup-prefix="">
                                                0</div>
                                        </div>
                                        <!--end::Number-->
                                        <!--begin::Label-->
                                        <div class="fw-semibold fs-6 text-gray-400">Gold</div>
                                        <!--end::Label-->
                                    </div>
                                    <!--end::Stat-->
                                </div>
                ...
                <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold mb-8">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-active-primary pb-4 active" data-kt-countup-tabs="true"
                            data-bs-toggle="tab" href="#kt_customer_view_overview_followers">{{ __('site.followers')
                            }}</a>
                    </li>
                    <!--end:::Tab item-->
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-active-primary pb-4" data-kt-countup-tabs="true" data-bs-toggle="tab"
                            href="#kt_customer_view_overview_following">{{ __('site.following') }}</a>
                    </li>
                    <!--end:::Tab item-->
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-active-primary pb-4" data-kt-countup-tabs="true" data-bs-toggle="tab"
                            href="#kt_customer_view_overview_rooms">{{ __('site.rooms') }}</a>
                    </li>
                    <!--end:::Tab item-->
        ...
        <div class="tab-content" id="myTabContent">
            {{-- followers --}}
            <div class="tab-pane fade show active" id="kt_customer_view_overview_followers" role="tab-panel">
                <div class="d-flex flex-column gap-7 gap-lg-10">
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            <div class="container">
                                <div class="row row-cols-2 row-cols-lg-6 g-2 g-lg-3" id="table-content-followers">
                                    {{-- branch users --}}
                                </div>
                            </div>
            ...
            {{-- following --}}
            <div class="tab-pane fade show" id="kt_customer_view_overview_following" role="tab-panel">
                <div class="d-flex flex-column gap-7 gap-lg-10">
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            <div class="container">
                                <div class="row row-cols-2 row-cols-lg-6 g-2 g-lg-3" id="table-content-following">
                                    {{-- branch users --}}
                                </div>
                            </div>
            ...
            {{-- rooms --}}
            <div class="tab-pane fade show" id="kt_customer_view_overview_rooms" role="tab-panel">
                <div class="d-flex flex-column gap-7 gap-lg-10">
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            <div class="container">
                                <div class="row row-cols-2" id="table-content-rooms">
                                    {{-- branch users --}}
                                </div>
                            </div>
            ...
            {{-- wallets --}}
            <div class="tab-pane fade show" id="kt_customer_view_overview_wallets" role="tab-panel">
                <div class="d-flex flex-column gap-7 gap-lg-10">
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            <div class="container">
                                <div class="row row-cols-2" id="table-content-wallets">
                                    {{-- branch users --}}
                                </div>
                            </div>
