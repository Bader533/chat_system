...
@section('page_name',__('site.groups'))
...
<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
    ...
    <!--end::Item-->
    <!--begin::Item-->
    <li class="breadcrumb-item text-muted">{{__('site.groups')}}</li>
    <!--end::Item-->
</ul>
@endsection
...
<script>
    ...
    function buttonSideBar() {
        const button = document.getElementById('groups');
        button.classList.add('active');
    }

    function getGroups(page = 1, query = null) {
        axios.get('/getGroup', {
            params: {
                page: page,
                query: query,
