<form id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row">
            ...
            <div class="card-body text-center pt-0">
                ...
                <style>
                    .image-input-placeholder {
                        background-image: url('{{asset($gift->avatar_url ?? "assets/media/svg/files/blank-image.svg")}}');
                    }
                </style>
    ...
    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
            ...
            <div class="card-body pt-0">
                ...
                <div class="row">
                    <div class="col-6 mb-10 fv-row">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" name="name_en" id="name_en" value="{{$gift->name_en ?? null}}" class="form-control mb-2"
                    ...
                    <div class="col-6 mb-10 fv-row">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" name="name_ar" id="name_ar" value="{{$gift->name_ar ?? null}}" class="form-control mb-2"
                ...
                <div class="mb-10 fv-row">
                    ...
                    <select class="form-select mb-2" data-control="select2" data-hide-search="true"
                        ...
                        <option></option>
                        <option value="1" @selected(($gift->status ?? null) == 1)>{{__('site.active')}}</option>
                        <option value="0" @selected(($gift->status ?? null) == 0)>{{__('site.non_active')}}</option>
                    </select>
                </div>
                <!--end::status-->
                ...
                <div class="row">
                    <div class="col-6 mb-10 fv-row">
                        ...
                        <select class="form-select mb-2" data-control="select2" data-hide-search="true"
                            ...
                            <option></option>
                            <option value="diamonds" @if(($gift->type_points ?? null) == 'diamonds') selected="selected"
                                @endif>Diamonds
                            </option>
                            <option value="gold" @if(($gift->type_points ?? null) == 'gold') selected="selected"
                                @endif>Gold
                            </option>
                            <option value="silver" @if(($gift->type_points ?? null) == 'silver') selected="selected"
                                @endif>Silver
                            </option>
                        </select>
                        <!--end::Input-->
                    ...
                    <div class="col-6 mb-10 fv-row">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" name="value_points" id="value_points" value="{{$gift->value_points ?? null}}" class="form-control mb-2"
        ...
        <div class="d-flex justify-content-end">
            <!--begin::Button-->
            <a href="{{route('gift.index')}}" id="kt_ecommerce_add_product_cancel"
