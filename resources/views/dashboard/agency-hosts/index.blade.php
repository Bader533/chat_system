...
@section('page_name',__('site.agency_hosts'))
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                        <!--begin::Add customer-->
                        <a href="{{ route('agency-hosts.create') }}"
                            class="btn btn-primary">{{__('site.add_agency_host')}}
                        </a>
                        <!--end::Add customer-->
                    </div>
                    <!--end::Toolbar-->
...
<script>
    ...
    function getAgencyHosts(page = 1, query = null){
        axios.get('/get-agency-hosts', {
            params: {
                page: page,
                query: query,
            }
