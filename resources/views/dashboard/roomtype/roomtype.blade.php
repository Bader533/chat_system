<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
    ...
    <tbody class="fw-semibold text-gray-600" id="table_data">
        ...
        <tr>
            <!--begin::Name=-->
            <td>
                <a class="text-gray-800 text-hover-primary mb-1">{{ $item->name_en }}</a>
            </td>
            <!--end::Name=-->
            ...
            <td class="text-end">
                ...
                <a href="{{route('roomtype.edit',$item->slug)}}"
        ...
        <div class="col-sm">
            <div class="pagination">
                ...
                <li class="page-item"><a class="page-link"
                        onclick="getRoomTpyes('{{ $contacts->currentPage() - 1 }}')">‹</a>
                </li>
                @endif
                @php
                ...
                @if ($startPage > 1)
                <li class="page-item"><a class="page-link" onclick="getRoomTpyes(1)">1</a></li>
                @if ($startPage > 2)
                <li class="page-item disabled"><span class="page-link">...</span></li>
                @endif
                @endif
                ...
                @for ($i = $startPage; $i <= $endPage; $i++) <li
                    ...
                    <a class="page-link" onclick="getRoomTpyes('{{ $i }}')">{{ $i }}</a>
                    </li>
                    @endfor
                    ...
                    @if ($endPage < $contacts->lastPage())
                        @if ($endPage < $contacts->lastPage() - 1)
                            ...
                            @endif
                            <li class="page-item"><a class="page-link"
                                    onclick="getRoomTpyes('{{ $contacts->lastPage() }}')">{{
                            ...
                            <li class="page-item"><a class="page-link"
                                    onclick="getRoomTpyes('{{ $contacts->currentPage() + 1 }}')">›</a></li>
                            @else
                            <li class="page-item disabled"><span class="page-link">›</span></li>
                            @endif
            </div>
