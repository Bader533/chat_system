...
@section('page_name',__('site.edit').' '.$roomtype->name)
...
<div id="kt_app_content" class="app-content flex-column-fluid">
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            {{-- form --}}
            @include('dashboard.roomtype._form', ['roomtype' => $roomtype ,'function' => 'update'])
            {{-- end form --}}
        </div>
...
<script>
    ...
    function update() {
        ...
        axios.post('/roomtype/{{$roomtype->slug}}', formData)
