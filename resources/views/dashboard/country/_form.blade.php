            ...
            <div class="card-body text-center pt-0">
                ...
                <style>
                    .image-input-placeholder {
                        background-image: url('{{asset($country->avatar_url ?? "assets/media/svg/files/blank-image.svg")}}');
                    }
                </style>
            ...
            <div class="card-body pt-0">
                ...
                <div class="mb-10 fv-row">
                    ...
                    <select class="form-select mb-2" data-control="select2" data-hide-search="true"
                        ...
                        <option></option>
                        <option value="1" @selected(($country->status ?? null) == 1)>{{__('site.active')}}</option>
                        <option value="0" @selected(($country->status ?? null) == 0)>{{__('site.non_active')}}</option>
                    </select>
