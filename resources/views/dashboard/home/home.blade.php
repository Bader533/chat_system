                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px"
                                ...
                                <div class="menu-item px-3">
                                    <a href="{{route('agency.create')}}"
                                        class="menu-link px-3">{{__('site.add_new_agency')}}</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="{{route('user.index')}}" class="menu-link px-3">{{__('site.users')}}</a>
                                </div>
                                <!--end::Menu item-->

                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="{{route('room.index')}}" class="menu-link px-3">{{__('site.rooms')}}</a>
                                </div>
                                <!--end::Menu item-->

                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="{{route('group.index')}}" class="menu-link px-3">{{__('site.groups')}}</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu separator-->
                                ...
                                <div class="menu-item px-3">
                                    <div class="menu-content px-3 py-3">
                                        <a href="{{route('post.create')}}"
                                            class="btn btn-primary btn-sm px-4">{{__('site.add_new_post')}}</a>
                                    </div>
                                </div>
                                <!--end::Menu item-->
                            </div>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                        ...
                                        <div class="m-0">
                                            <!--begin::Number-->
                                            <span
                                                class="text-gray-700 fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1">{{$user_count}}</span>
                                            <!--end::Number-->
                                            <!--begin::Desc-->
                                            <span class="text-gray-500 fw-semibold fs-6">{{__('site.users')}}</span>
                                            <!--end::Desc-->
                                        </div>
                                        <!--end::Stats-->
                                    </div>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                        ...
                                        <div class="m-0">
                                            <!--begin::Number-->
                                            <span
                                                class="text-gray-700 fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1">{{$agency_count}}</span>
                                            <!--end::Number-->
                                            <!--begin::Desc-->
                                            <span class="text-gray-500 fw-semibold fs-6">{{__('site.agencies')}}</span>
                                            <!--end::Desc-->
                                        </div>
                                        <!--end::Stats-->
                                    </div>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                        ...
                                        <div class="m-0">
                                            <!--begin::Number-->
                                            <span
                                                class="text-gray-700 fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1">{{$room_count}}</span>
                                            <!--end::Number-->
                                            <!--begin::Desc-->
                                            <span class="text-gray-500 fw-semibold fs-6">{{__('site.rooms')}}</span>
                                            <!--end::Desc-->
                                        </div>
                                        <!--end::Stats-->
                                    </div>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                        ...
                                        <div class="m-0">
                                            <!--begin::Number-->
                                            <span
                                                class="text-gray-700 fw-bolder d-block fs-2qx lh-1 ls-n1 mb-1">{{$wallet_count}}</span>
                                            <!--end::Number-->
                                            <!--begin::Desc-->
                                            <span
                                                class="text-gray-500 fw-semibold fs-6">{{__('site.transactions')}}</span>
                                            <!--end::Desc-->
                                        </div>
                                        <!--end::Stats-->
                                    </div>
                        ...
                        <div id="kt_sliders_widget_1_slider"
                            ...
                            <div class="card-header pt-5">
                                ...
                                <h4 class="card-title d-flex align-items-start flex-column">
                                    <span class="card-label fw-bold text-gray-800">{{__('site.rooms')}}</span>
                                    <span class="text-gray-400 mt-1 fw-bold fs-7">@lang('site.room_active_count') :
                                        {{$room_active_count}}</span>
                                </h4>
                                <!--end::Title-->
                                <!--begin::Toolbar-->
