<form id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row">
            ...
            <div class="card-body text-center pt-0">
                ...
                <style>
                    .image-input-placeholder {
                        background-image: url('{{asset($city->avatar_url ?? "assets/media/svg/files/blank-image.svg")}}');
                    }
                </style>
    ...
    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
            ...
            <div class="card-body pt-0">
                ...
                <div class="mb-10 fv-row">
                    ...
                    <select class="form-select mb-2" data-control="select2" data-hide-search="true"
                        data-placeholder="Select an option" id="country_id" required>
                        <option></option>
                ...
                <div class="mb-10 fv-row">
                    ...
                    <select class="form-select mb-2" data-control="select2" data-hide-search="true"
                        ...
                        <option></option>
                        <option value="1" @selected(($city->status ?? null) == 1)>{{__('site.active')}}</option>
                        <option value="0" @selected(($city->status ?? null) == 0)>{{__('site.non_active')}}</option>
                    </select>
        ...
        <div class="d-flex justify-content-end">
            <!--begin::Button-->
            <a href="{{route('city.index')}}" id="kt_ecommerce_add_product_cancel"
