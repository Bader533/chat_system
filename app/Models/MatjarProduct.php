...
class MatjarProduct extends Model
{
    use HasFactory;
    ...
    {
        return $this->belongsTo(MatjarCategory::class, 'matjar_category_id');
    }

    public function users()
    {
        return $this->belongsToMany(User::class, 'user_products', 'matjar_product_id', 'user_id')
